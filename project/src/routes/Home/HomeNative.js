...
class HomeNative extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.swiper = new Swiper(this.swiperID, {
            ...
            //    //      return <span className={index1 === index ? `theme active ${className}`: `theme ${className}`}
            //    //                   key={index} >{item}</span>
            //    //  })
            // }
            // },
        ...
        return (<section className={'homeBox'}>
            <div>
                ...
                <div className='bannerBox'>
                    <div className='swiper-container' ref={self => this.swiperID = self} onChange={this.onChange}>
